...
| **Interactive Page Reordering & 90° Rotation** | 🟢 Fully Working | Visual page rotation, 1-click **AI Auto-Sort by Page #** (`🪄 Auto-Sort Pages`), jump-to-start (⏮), jump-to-end (⏭), fine-grained left/right arrows, and page pruning directly in Triage Studio. |
